...
<head>
    ...
    <title>Class Attendance Review</title>
</head>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td valign="middle" style="color:#ffffff;">
                                    ...
                                    <div style="font-size:26px; line-height:1.2; font-weight:700; margin-top:8px;">{{ $isBlocked ? 'Class enrollment blocked' : 'Class attendance review' }}</div>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:32px;">
                        ...
                        <div style="margin-top:16px; font-size:15px; line-height:1.8; color:#5a5246;">
                            You were marked as not attended for <strong>{{ $classTitle }}</strong> on {{ $classDate }} at {{ $startTime }}.
                        </div>
                        @if ($isBlocked)
                            <div style="margin-top:16px; font-size:15px; line-height:1.8; color:#5a5246;">
